<template>
  <div class="about centerText">
    ...
    <hr>
    <div class="longText">
    <p>O Vernum Cloud é um projeto desenvolvido pela equipe de P&D (Pesquisa e Desenvolvimento) da equipe de FRC <strong>CyberRain #9611</strong>. <br> Aqui, a equipe tem uma plataforma própria para gerênciar arquivos, registros diários e manter contato com outros integrantes através de um fórum. Além disso, tudo pode ser restringido à própria divisão ou à equipe toda, conforme for necessário. <br><br> É com o Vernum Cloud também que os dados dos integrantes são armazenados e controlados pelos técnicos da equipe, que possuem atribuições para criar e gerenciar processos de seleção de pessoas para a equipe, conforme demanda de cada divisão.</p>
    <br><br><br><br>
